								...
								"""),format.raw/*67.9*/("""<tr>
									...
									<td>
										"""),_display_(/*73.12*/for(skill <- project.getJobs()) yield /*73.43*/{_display_(Seq[Any](format.raw/*73.44*/("""
											"""),format.raw/*74.12*/("""<a href="/skills/"""),_display_(/*74.30*/skill),format.raw/*74.35*/("""" target="_blank"> """),_display_(/*74.55*/skill/*74.60*/.getName()),format.raw/*74.70*/("""</a>
										""")))}),format.raw/*75.12*/("""
									"""),format.raw/*76.10*/("""</td>
